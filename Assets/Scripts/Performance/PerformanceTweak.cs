...
public class PerformanceTweak : MonoBehaviour
{
	public FPSCounter fpsCounter;
	//var water : IslandWater;
	public Terrain terrain;
	public float messageTime = 10.0f;
	public float scrollTime = 0.7f;

	private string[] messages;
	private float[] times;
	private float lastTime = 0.0f;
	private bool doneNotes = false;
	private float origDetailDist = 0.0f;
	private float origSplatDist = 0.0f;
	private float origTreeDist = 0.0f;
	private float origMaxLOD = 0;
	private bool softVegetationOff = false;
	private bool splatmapsOff = false;

	private float lowFPS = 15.0f;

	private float skipChangesTimeout = 1.0f;
	private int nextTerrainChange = 0;
